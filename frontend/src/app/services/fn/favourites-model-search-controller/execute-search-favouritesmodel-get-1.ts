...
export function executeSearchFavouritesmodelGet1(http: HttpClient, rootUrl: string, params?: ExecuteSearchFavouritesmodelGet1$Params, context?: HttpContext): Observable<StrictHttpResponse<CollectionModelEntityModelFavouritesModel>> {
...
executeSearchFavouritesmodelGet1.PATH = '/favouritesModels/search/findFavouriteMotorcyclesByUser';
